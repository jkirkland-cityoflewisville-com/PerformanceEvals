;(function() {   
    if (window.location.host === 'apps') {
        ...
        if (window.location.href.split('://')[1].split('.')[0].toLowerCase() !== 'apps') {
            ...
            oauthRedirectUrl = window.location.protocol + '//' + window.location.href.split('://')[1].split('.')[0].toLowerCase() + '.cityoflewisville.com' + window.location.pathname + 'oauth/index.html'
        } else {
